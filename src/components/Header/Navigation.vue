    ...
    <ul class="flex flex-row list-none px-6 text-white">
      ...
      >
        ...
        >
          ...
          <span class="relative z-50" v-else-if="$i18n.locale === 'en'">
            PhotoAlbums
          </span>
          <DropdownMenu>
            <DropdownItem name="相册1">
              <span class="relative z-50">相册1</span>
            </DropdownItem>
            <DropdownItem name="相册2">
              <span class="relative z-50">相册2</span>
            </DropdownItem>
          </DropdownMenu>
        </Dropdown>
      </li>
