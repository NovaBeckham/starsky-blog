<template>
  <div id="App-Wrapper" class="app-wrapper theme-dark" :style="wrapperStyle">
    <div
      id="App-Container"
      class="app-container max-w-10/12 lg:max-w-screen-2xl px-3 lg:px-8"
    >
      <Header />
      <div class="app-banner app-banner-image header-image" />
      <div class="app-banner app-banner-screen header-base-background" />
...
const initialApp = () => {
  ...
  if (typeof footerHeight === "number") {
    wrapperStyle.value = {
      "min-height": screen.height - footerHeight * 2 + "px",
    }
  } else {
    wrapperStyle.value = {
